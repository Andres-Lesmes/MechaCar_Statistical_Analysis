...
In order to compare the MechaCar cars performance versus the competition. We should realize an analysis to see how the maintenance costs of the MechaCar cars differ from the maintenance costs of the competition cars. In order to do this analysis we would need data of the anual costs maintenance of the MechaCars and the competition cars and then we would realize a t-test to compare how the mainetnance costs of the MechaCar cars and the competition cars differ. For this analysis our null hypothesis would be that the maintenance costs of the MechaCar cars do not differ from the competition cars.  
